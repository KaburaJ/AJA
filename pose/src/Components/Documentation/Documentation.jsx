        ...
        <div className="documentation-container">
            <main id="main-doc">
                ...
                <section className="main-section" id="History">
                    ...
                    <p>Notwithstanding, the milestones achieved in animal pose estimation is nowhere near that of human pose estimation. The challenges that are there, which include the gaps present in determining what can be defined as a joint and what cannot, might explain why. We chose this track for that exact reason. What follows is a breakdown of the steps we took in curating not only a sound but accessible and reproducible documentation for the process followed.</p>
                </section>
